...
Class Mysql {
    ...
    public function __construct() {
        ...
        $this->connect($GLOBALS["hostname"], $GLOBALS["username"], $GLOBALS["password"], $GLOBALS["database"], $GLOBALS["pconnect"]);
        $this->is_log = $GLOBALS["log"];
        if($this->is_log){
            $handle = fopen($GLOBALS["logfilepath"]."dblog.txt", "a+");
            $this->handle=$handle;
        }
    }
